...
public class MemberController {
	...
	public String process(@RequestParam(value="pageNum",defaultValue="1")int currentPage,HttpSession session,
			Model model) {
		...
		PagingUtil page = new PagingUtil(currentPage,count,10,10,"myPage.do");
	...
	//이미지 출력
	@RequestMapping("/member/gameView.do")
